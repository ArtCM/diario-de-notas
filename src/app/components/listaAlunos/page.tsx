...
type ListaAlunosProps = {
    listaAlunos: Aluno[];
    setListaAlunos: React.Dispatch<React.SetStateAction<Aluno[]>>;
};

export default function ListaAlunos({ listaAlunos, setListaAlunos }: ListaAlunosProps) {
    ...
    return (
      <section className="listaAlunos">
        <AdicionarAluno buttonText="Adicionar Aluno" buttonColor="var(--green)" onClick={handleOpenModal} />
        ...
        <AdicionarAlunoModal isOpen={isModalOpen} onClose={handleCloseModal} onSubmit={handleAddStudent} />
      </section>
    );
  }